...
if [ ! -d $1 ] then mkdir $1
if [ ! -d $1/artefacts-UBL-2.3-$2-$3 ] then mkdir $1/artefacts-UBL-2.3-$2-$3
if [ ! -d $1/artefacts-UBL-2.3-$2-$3/archive-only-not-in-final-distribution/ ] then mkdir $1/artefacts-UBL-2.3-$2-$3/archive-only-not-in-final-distribution/
cp artefacts.console.$3.txt $1/artefacts-UBL-2.3-$2-$3/archive-only-not-in-final-distribution/
